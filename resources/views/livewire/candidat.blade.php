    ...
    <div class="container-fluid">
        <form class="row my-3" action="">
            ...
            <div class="mb-3 col-xs-12 col-sm-6 col-md-2 ">
              <select wire:model='orderBy' class="form-select" name="" id="">
            ...
            <div class="mb-3 col-xs-12 col-sm-6 col-md-2 ">
                <select wire:model='orderAsc' class="form-select" name="" id="">
                  <option value="1">Croissant</option>
                  <option value="0">Décroissant</option>
                </select>
            </div>
            <div class="mb-3 col-xs-12 col-sm-6 col-md-2 ">
              <select wire:model='perPage' class="form-control" name="" id="">
